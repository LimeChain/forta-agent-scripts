...
const fromAddress = "0x000000000000000000000000ffff"
const accountAddress = "0x000000000000000000000000aaaa"
    ...
    it("returns a finding on RoleGranted event", async () => {
      ...
      expect(findings).toStrictEqual([
        Finding.fromObject({
          ...
          description: `Role setSwapFeePercentage granted for 0xaaaa`,
    ...
    it("returns a finding on RoleRevoked event", async () => {
      ...
      expect(findings).toStrictEqual([
        Finding.fromObject({
          ...
          description: `Role ${unknownRole} revoked for 0xaaaa`,
          alertId: "BALANCER-ROLE-CHANGE",
          protocol: "balancer",
          type: FindingType.Info,
          severity: FindingSeverity.Medium,
